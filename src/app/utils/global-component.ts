...
export const GlobalComponent = {
    ...
    usuarios_listar_deudas_paginate: URL_BASE + 'admin/usuarios/:id/deudas-paginate',
    ...
    configuracion_actualizar_veripagos: URL_BASE + 'admin/configuracion/updateVeripagos',
